...
class MockSNMPAgentAPIClient:
    ...
    def restart_agent(self, force: bool = False, timeout_seconds: int = 30) -> Dict[str, Any]:
...
def demonstrate_api_usage():
    ...
    try:
        ...
        enabled_behaviors = [name for name, conf in behaviors.items() 
        ...
        print("  You can test with: snmpget -v2c -c public 127.0.0.1:11611 1.3.6.1.2.1.1.1.0")
...
def test_snmpv3_security_api():
    ...
    try:
        ...
        print(f"  Clock skew: {security['time_window_failures']['clock_skew_seconds']} seconds")
        print(f"  Auth failures: {security['authentication_failures']['enabled']}")
        print(f"  Wrong credentials rate: {security['authentication_failures']['wrong_credentials_rate']}%")
        ...
        print("  snmpget -v3 -l authNoPriv -u wronguser -a MD5 -A wrongpass 127.0.0.1:11611 1.3.6.1.2.1.1.1.0")
