...
def test_delay_variation():
    ...
    cmd = [
        ...
        "127.0.0.1:11611", "1.3.6.1.2.1.2.2.1.6.1"
    ]
...
def test_writecache_variation():
    ...
    set_cmd = [
        ...
        "127.0.0.1:11611",
        "1.3.6.1.2.1.1.1.0", "s", "Modified by writecache test"
    ]
...
def test_invalid_community():
    ...
    cmd = [
        "snmpget", "-v2c", "-c", "nonexistent_community",
...
def main():
    ...
    print("\n# SET operation:")
    print("snmpset -v2c -c variation/writecache 127.0.0.1:11611 1.3.6.1.2.1.1.1.0 s 'Test'")
