...
class DeviceStateMachine:
    ...
    def __init__(self, device_type: str = "generic", initial_state: str = "operational"):
        ...
        self.logger.info(f"Initialized {device_type} state machine in state '{initial_state}'")
    ...
    def transition_to(self, target_state: str, trigger: TransitionTrigger = TransitionTrigger.MANUAL, reason: str = "Manual transition") -> bool:
        ...
        with self._lock:
            ...
            if not self.can_transition_to(target_state):
                self.logger.warning(f"Transition from '{self.current_state}' to '{target_state}' not allowed")
                return False
            ...
            self.logger.info(f"State transition: {old_state} -> {target_state} ({reason})")
    ...
    def force_transition_to(self, target_state: str, reason: str = "Forced transition") -> bool:
        ...
        with self._lock:
            ...
            if current_state_def and target_state not in current_state_def.next_states:
                ...
                # Perform transition
                result = self.transition_to(target_state, TransitionTrigger.MANUAL, reason)
                ...
                return self.transition_to(target_state, TransitionTrigger.MANUAL, reason)
    ...
    def get_state_statistics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            for transition in self.state_history:
                ...
                state_durations[state_name].append(transition.duration_in_previous_state)
            ...
            return {
                ...
                "current_state_info": {
                    "oid_availability": current_state_def.oid_availability if current_state_def else 100,
                    "response_delay_ms": current_state_def.response_delay_ms if current_state_def else 0,
                    "error_rate": current_state_def.error_rate if current_state_def else 0,
                }
            }
            ...
            if current_state_def.response_delay_ms > 0:
                ...
                if "delay" not in tag:
                    ...
                    if "=" in value:
                        ...
                        value = f"value={value},wait={current_state_def.response_delay_ms}"
