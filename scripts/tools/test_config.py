...
"""
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Should contain delay tags or original content
        assert len(content) > 0, "Generated file should have content"
        # The delay behavior may be applied via variation modules, not in the .snmprec file
        print("✓ .snmprec generation works")
...
def test_cli_behavior():
    ...
    try:
        from src.mock_snmp_agent import main
    except ImportError:
