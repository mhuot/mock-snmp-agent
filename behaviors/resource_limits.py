...
class ResourceConstraintSimulator:
    ...
    def get_performance_stats(self) -> Dict:
        ...
        return {
            ...
            "success_rate": (
                (self.total_requests - self.dropped_requests) / max(self.total_requests, 1)
            ) * 100,
            ...
            "concurrent_limit_reached": self.active_requests >= self.limits.max_concurrent_requests
        }
...
def generate_resource_snmprec_entries(
    simulator: ResourceConstraintSimulator,
